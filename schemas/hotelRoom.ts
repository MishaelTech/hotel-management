...
const hotelRoom = {
    ...
    fields: [
        ...
        defineField({
            ...
            validation: Rule =>
                Rule.required().min(3).error("Minimum of 3 images"),
        }),
        defineField({
            name: "coverImage",
            title: "Cover Image",
        ...
        defineField({
            ...
            validation: Rule => Rule.required(),
            initialValue:
                "Check-in time is 12:00pm, Check-out is 11:59am. If you leave behind any items, please contact the receptionist.",
        }),
        defineField({
            name: "dimension",
            title: "Dimension",
