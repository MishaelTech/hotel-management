...
const BookRoomCta: FC<Props> = props => {
    ...
    return (
        <div className="px-7 py-6">
            ...
            <div className="w-full border-b-2 border-b-orange-700 my-2" />
            ...
            {calcNoOfDays() > 0 ? (
                <p className="mt-3 text-lg font-semibold">Total Price <span className="text-green-500 text-lg font-semibold">${calcNoOfDays() * discountPrice}</span></p>
            ) : (
                <></>
            )}
